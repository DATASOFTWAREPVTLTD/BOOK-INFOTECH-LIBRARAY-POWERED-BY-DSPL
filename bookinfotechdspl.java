...
public class BookInfotech { // class name
        ...
        do { // do-while loop
            ...
            switch (choice) { // switch statement
                ...
                case 2:
                    ...
                    break; // break statement
                case 3:
                    System.out.println("Thank you for using the Book Infotech Library Management System. Goodbye!");
                    break;
                default:
    ...
    public static void performAdminTasks(Scanner scanner) { // performAdminTasks method
        String adminPassword = "DSPL"; // declare a variable to store the admin password
